...
@interface ExperienceProgressView ()
...
@implementation ExperienceProgressView



+(instancetype)experienceProgressView
{
   return  [[[NSBundle mainBundle]loadNibNamed:@"ExperienceProgressView" owner:self options:nil]firstObject] ;
}
